...
fun MatchCard(
    ...
    //Generated by ChatGPT during error solving
    ...
    Card(
        ...
        Row(
            ...
            resultText = item.score1.toString() + stringResource(R.string.DoubleDot) + item.score2.toString()
            var list = listOf(stringResource(R.string.Win), stringResource(R.string.draw),
                stringResource(R.string.Lose)
            )
            if(viewModel.tournament.firstStage == stringResource(R.string.single_elminiation)){
